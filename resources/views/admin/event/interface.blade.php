...
@section('content')
        ...
        <table style="width:100%;border-collapse:collapse;font-size:13px">
            ...
            <tbody>
                @forelse($events as $ev)
                    <tr style="border-top:1px solid #2a2d3e" onmouseover="this.style.background='rgba(255,255,255,0.02)'"
                        ...
                        <td style="padding:12px 16px">
                            ...
                            @else
                                <div
                                    style="width:60px;height:44px;background:#13151f;border-radius:8px;border:1px solid #2a2d3e;display:flex;align-items:center;justify-content:center;font-size:11px;color:#4b5563">
                                    No photo</div>
                            @endif
                        </td>
                        ...
                        <td style="padding:12px 16px;text-align:center">
                            <div style="display:flex;justify-content:center;gap:8px">
                                ...
                                <a href="{{ route('admin.event.edit', $ev) }}"
                                    ...
                                    onmouseover="this.style.background='rgba(124,111,247,0.1)'"
                                    onmouseout="this.style.background='transparent'">Edit</a>

                                <form action="{{ route('admin.event.destroy', $ev) }}" method="POST"
                ...
                @empty
                    <tr>
                        <td colspan="7" style="text-align:center;padding:48px;color:#4b5563">No events found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div id="participantsModal"
        style="display:none;position:fixed;inset:0;z-index:999;background:rgba(0,0,0,0.6);align-items:center;justify-content:center">
        <div
            style="background:#1a1d2e;border:1px solid #2a2d3e;border-radius:14px;width:90%;max-width:750px;max-height:80vh;display:flex;flex-direction:column">

            {{-- Header --}}
            <div
                style="padding:16px 20px;border-bottom:1px solid #2a2d3e;display:flex;justify-content:space-between;align-items:center;flex-shrink:0">
                <div>
                ...
                <button onclick="closeModal()"
                    style="background:transparent;border:none;color:#6b7280;font-size:20px;cursor:pointer;line-height:1">✕</button>
            </div>
