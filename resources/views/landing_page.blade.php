...
<div class="bg-indigo-900 relative min-h-screen">
    ...
    <div class="container mx-auto px-6 md:px-12 relative z-10 flex flex-col lg:flex-row items-center py-24 xl:py-40"
         x-data="{
            activeStack: 1, total: 4, init() {
                setInterval(() => {this.activeStack = this.activeStack < this.total ? this.activeStack + 1 : 1;}, 3000);}}">
        ...
        <div class="lg:w-1/3 w-full flex justify-center lg:justify-end lg:ml-auto relative h-[600px] md:h-[750px] items-center">
