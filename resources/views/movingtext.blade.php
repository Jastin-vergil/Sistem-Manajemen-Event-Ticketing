...
<head>
    <meta charset="utf-8">
    <title>Rotating Words Animation - Tailwind CSS</title>
...
<body class="relative font-inter antialiased">
    <main class="relative min-h-screen flex flex-col justify-center bg-slate-900 overflow-hidden">
        <div class="w-full max-w-6xl mx-auto px-4 md:px-6 py-24 text-center">

            <div
                class="font-extrabold text-3xl md:text-4xl [text-wrap:balance] bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 to-50% to-slate-200 z-50">
                The ultimate ticketing platform for
                <span
