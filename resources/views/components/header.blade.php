      ...
      <nav class="flex items-center justify-between py-4 lg:px-12 px-6 shadow-xl">
          ...
          <div class="flex items-center justify-between lg:w-auto w-full">
              <div class="flex items-center flex-shrink-0 text-indigo-700 mr-6">
                  <span class="text-3xl tracking-tight font-black"
                      style="font-family: 'Montserrat', sans-serif;">Tixly</span>
              </div>

              <div class="block lg:hidden">
                  <button id="nav"
                      class="flex items-center px-3 py-2 border-2 rounded text-indigo-400 border-indigo-700 hover:text-white hover:bg-indigo-700 transition-colors">
          ...
          <div class="menu w-full hidden lg:flex lg:items-center lg:w-auto flex-grow lg:justify-end">
              <div class="text-md font-bold text-indigo-600 lg:flex lg:flex-row space-x-2"
